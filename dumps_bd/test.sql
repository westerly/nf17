CREATE TABLE province (
  ...
  code varchar(3),
  name_province varchar(250),
  name_province_uppercase varchar(255),
  province_slug varchar(255),
...
DELETE FROM province where id_region = 23 or id_region = 24;

INSERT INTO departements VALUES SELECT id_departement, name_province, id_region FROM province;