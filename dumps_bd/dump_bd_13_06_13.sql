...
ALTER TABLE ONLY public.users DROP CONSTRAINT users_login_mdp_key;
...
59	2013-06-06 21:45:13.752	Bordeaux	\N
60	2013-06-06 21:45:36.261	Toulouse	\N
61	2013-06-06 21:47:59.424	Bordeaux	\N
\.
...
58	Pluie	10	10	zeffijzefefhefhzefezifhef\t\t\t\t\r\r\r\n\n\t\t\t\t\t\t 	56
56	Pluie	9	10	zeffijzefefhefhzefezifhef\t\t\t\t\r\n\n\t\t\t\t\t\t 	58
\.
...
24	12	26	25	frgrgeergregregregregregregrgrgerg\t\t\t\t 	56
22	26	27	25	frgrgeergregregregregregregrgrgerg\t\t\t\t 	58
\.
...
COPY users (user_id, login, mdp) FROM stdin;
1	admin	admin
\.
...
35	10	Nord	8	rezdfbzefgezufgzeufgezfuigefyugezfg\t\t\t\t 	56
\.
...
--
-- Name: users_login_mdp_key; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY users
    ADD CONSTRAINT users_login_mdp_key UNIQUE (login, mdp);
