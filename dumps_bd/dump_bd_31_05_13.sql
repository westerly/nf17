...
ALTER TABLE ONLY public.historiques DROP CONSTRAINT historiques_capteur_fin_key;
...
56	2013-05-31 15:59:11.272	Toulouse	2013-05-31 15:59:58.947
56	2013-05-31 16:07:50.459	Toulouse	\N
...
--
-- Name: historiques_capteur_fin_key; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY historiques
    ADD CONSTRAINT historiques_capteur_fin_key UNIQUE (capteur_id, fin);
